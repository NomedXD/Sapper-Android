...
public enum Type {
    BOMB(R.drawable.bomb), EMPTY(R.drawable.nobomb), CLOSED(R.drawable.closed), FLAG(R.drawable.flag),
    NUMBER_1(R.drawable.num1), NUMBER_2(R.drawable.num2),
    NUMBER_3(R.drawable.num3), NUMBER_4(R.drawable.num4), NUMBER_5(R.drawable.num5),
